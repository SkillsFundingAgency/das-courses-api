...
{
    public class FrameworkImport : IEntityTypeConfiguration<Domain.Entities.FrameworkImport>
    {
        public void Configure(EntityTypeBuilder<Domain.Entities.FrameworkImport> builder)
        {
            builder.ToTable("Framework_Import");
            ...
            builder.Ignore(x => x.FundingPeriods);

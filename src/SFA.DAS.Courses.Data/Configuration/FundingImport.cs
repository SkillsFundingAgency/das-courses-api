...
namespace SFA.DAS.Courses.Data.Configuration
{
    public class FundingImport : IEntityTypeConfiguration<Domain.Entities.FundingImport>
    {
        public void Configure(EntityTypeBuilder<Domain.Entities.FundingImport> builder)
        {
            ...
            builder.Property(x => x.RateWeighted).HasColumnName("RateWeighted").HasColumnType("decimal").HasPrecision(5, 2).IsRequired();
            builder.Property(x => x.RateUnWeighted).HasColumnName("RateUnWeighted").HasColumnType("decimal").HasPrecision(5, 2).IsRequired();

    ...
    public class GetStandardResponse
    {
        ...
        public static implicit operator GetStandardResponse(Standard source)
        {
            return new GetStandardResponse
            {
                ...
                Skills = source.OptionsIncludingCore.SelectManyOrEmptyList(x => x.Skills).Distinct().ToList(),
                Knowledge = source.OptionsIncludingCore.SelectManyOrEmptyList(x => x.Knowledge).Distinct().ToList(),
                Behaviours = source.OptionsIncludingCore.SelectManyOrEmptyList(x => x.Behaviours).Distinct().ToList(),

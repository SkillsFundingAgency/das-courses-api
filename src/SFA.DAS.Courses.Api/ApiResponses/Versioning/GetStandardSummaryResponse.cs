...
{
    public class GetStandardSummaryResponse
    {
        ...
        public static implicit operator GetStandardSummaryResponse(Standard importedStandard)
            => new GetStandardSummaryResponse
            {

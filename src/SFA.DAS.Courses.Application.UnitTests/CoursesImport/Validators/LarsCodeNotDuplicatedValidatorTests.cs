    ...
    public class LarsCodeNotDuplicatedValidatorTests
    {
        ...
        public void SetUp()
        {
            _allStandardImports = new Dictionary<string, List<StandardImport>>
            {
                ...
                {
                    "ST1003", new List<StandardImport>
                    {
                        new StandardImport { IfateReferenceNumber = "ST1003", Version = "1.0", LarsCode = "0" }
                    }
                },
                {
                    "ST1004", new List<StandardImport>
                    {
                        new StandardImport { IfateReferenceNumber = "ST1004", Version = "1.0", LarsCode = "" }
                    }
                }
            };
        ...
        public void Should_Not_Add_Failure_When_LarsCode_Is_Unique()
        {
            ...
            {
                new StandardImport { IfateReferenceNumber = "ST1005", Version = "1.0", LarsCode = "11111" }
            };
        ...
        [Test]
        public void Should_Not_Add_Failure_When_Duplicate_LarsCode_Is_Zero()
        {
            // Arrange
            var standardImports = new List<StandardImport>
            {
                new StandardImport { IfateReferenceNumber = "ST1005", Version = "1.0", LarsCode = "0" }
            };
        ...
        [Test]
        public void Should_Not_Add_Failure_When_Duplicate_LarsCode_Is_Empty()
        {
            // Arrange
            var standardImports = new List<StandardImport>
            {
                new StandardImport { IfateReferenceNumber = "ST1005", Version = "1.0", LarsCode = "" }
            };
        ...
        public void Should_Add_Failure_When_LarsCode_Is_Duplicated()
        {
            ...
            var standardImports = new List<StandardImport>
            {
                new StandardImport { IfateReferenceNumber = "ST1005", Version = "1.0", LarsCode = "12345" }
            };
            ...
            result.Errors.Should().ContainSingle(error => error.ErrorMessage ==
                "E1004: ST1005 version 1.0 has duplicated larsCode 12345 with standard ST1001 version 1.0");
        }
    }
}

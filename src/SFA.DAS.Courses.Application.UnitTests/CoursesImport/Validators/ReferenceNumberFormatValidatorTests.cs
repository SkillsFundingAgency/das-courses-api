...
namespace SFA.DAS.Courses.Application.UnitTests.CoursesImport.Validators
{
    ...
    public class ReferenceNumberFormatValidatorTests
    {
        ...
        [TestCase(Domain.Entities.ApprenticeshipType.ApprenticeshipUnit, "SC0001")]
        ...
        [TestCase(Domain.Entities.ApprenticeshipType.ApprenticeshipUnit, " SC0001 ", Reason = "Spaces around the reference number should be ignored as they are going to be trimmed")]
        ...
        [TestCase(Domain.Entities.ApprenticeshipType.FoundationApprenticeship, "SC1001")]
        ...
        [TestCase(Domain.Entities.ApprenticeshipType.Apprenticeship, "SC0001")]
